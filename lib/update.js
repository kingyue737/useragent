...
exports.update = function update(callback) {
  ...
  fs.readFile(exports.before, 'utf8', function reading(err, before) {
    ...
    // axios.get(exports.remote, function downloading(err, res, remote) {
      axios.get(exports.remote).then(promise => {
      if (promise.status !== 200) throw new Error('Invalid statusCode returned');
      ...
      fs.readFile(exports.after, 'utf8', function reading(err, after) {
        ...
        // Parse the contents
        exports.parse([ before, promise.data, after ], function parsing(err, results, source) {
